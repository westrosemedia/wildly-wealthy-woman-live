...
export default function ConnectPage() {
  return (
    <>
      <PageIntro
        ...
        title={
          <>
            ...
            <span className="italic text-lip">first.</span>
          </>
        }
      ...
      <section className="mx-auto grid max-w-[92rem] gap-12 px-5 pt-6 pb-20 md:grid-cols-[1.2fr_0.8fr] md:px-10">
        <div className="border border-mink/20 bg-snow px-6 py-10 md:px-10">
          <p className="text-[11px] tracking-[0.28em] text-lip uppercase">
            Waitlist
          </p>
          <h2 className="font-heading mt-3 text-4xl text-chocolate">
            Hold your name in the room.
          </h2>
          <p className="mt-4 mb-8 text-sm leading-relaxed text-mink">
            No spam. Cities, dates, and the private venue note only.
          </p>
          <WaitlistForm />
        </div>

        <aside className="space-y-10">
          <div className="border border-mink/20 p-8">
            <p className="text-[11px] tracking-[0.28em] text-lip uppercase">
              Direct
            </p>
            <a
              href={`mailto:${site.email}`}
              className="font-heading mt-4 block text-2xl text-chocolate hover:text-lip"
            >
              {site.email}
            </a>
            <p className="mt-3 text-sm leading-relaxed text-mink">
          ...
          <div className="border border-mink/20 p-8">
            ...
            <ul className="mt-4 space-y-3 text-sm text-mink">
              <li>
                <a href={site.host.site} className="hover:text-lip">
                  JackieMcDonald.ca
                </a>
              </li>
              <li>
                <a href={site.host.podcast} className="hover:text-lip">
