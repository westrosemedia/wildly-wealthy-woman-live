    ...
    <>
      <section className="relative min-h-[100svh] overflow-hidden">
        ...
        <div className="relative z-10 mx-auto flex min-h-[100svh] max-w-[92rem] flex-col justify-end px-5 pb-16 pt-36 md:px-10 md:pb-20">
          ...
          <h1 className="font-heading mt-4 max-w-5xl text-5xl leading-[0.92] text-cream sm:text-6xl md:text-[6.4rem]">
            Be booked.
            <br />
            Be remembered.
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
            ...
            <Link
              href="/events"
              className="inline-flex h-12 items-center justify-center border border-cream/40 px-8 text-[11px] tracking-[0.28em] text-cream uppercase transition-colors hover:border-gold hover:text-gold"
            >
              The night
            </Link>
          </div>
